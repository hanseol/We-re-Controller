					...
					<ul class="nav">
						<li>
							...
							<div id="subPages" class="collapse ">
								<ul class="nav">
									<li><a href="comCode/ComCodeList.do" class="">공통코드관리</a></li>
						...
						<li>
							<a href="#subPages4" data-toggle="collapse" class="collapsed"><i class="lnr lnr-file-empty"></i> <span>생산</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
							<div id="subPages4" class="collapse ">
								<ul class="nav">
									<li><a href="proOrder/addProOrderView.do" class="">생산지시관리</a></li>
									<li><a href="page-login.html" class="">Login</a></li>
									<li><a href="page-lockscreen.html" class="">Lockscreen</a></li>
								</ul>
							</div>
