							...
							<li><label class="control-inline fancy-checkbox"> <input
								...
								<p>
									<span class="title">Restart Server</span> <span
										...
										client-centric technologies without cooperative resources.</span> <span
										class="date">Oct 9, 2016</span>
								</p>
								<div class="controls">
							...
							<li><label class="control-inline fancy-checkbox"> <input
								...
								<p>
									<strong>Functional Spec Meeting</strong> <span
										...
										client-focused core competencies after parallel web-readiness.</span>
				...
				<div class="panel panel-scrolling">
					...
					<div class="panel-body">
						<ul class="list-unstyled activity-list">
							<li><img src="${pageContext.request.contextPath}/resources/images/user1.png" alt="Avatar"
							...
							<li><img src="${pageContext.request.contextPath}/resources/images/user2.png" alt="Avatar"
								class="img-circle pull-left avatar">
									<p>
										<a href="#">Daniel</a> has been added as a team member to
										project <a href="#">System Update</a> <span class="timestamp">Yesterday</span>
									</p></li>
							<li><img src="${pageContext.request.contextPath}/resources/images/user3.png" alt="Avatar"
								class="img-circle pull-left avatar">
									<p>
										<a href="#">Martha</a> created a new heatmap view <a href="#">Landing
											Page</a> <span class="timestamp">2 days ago</span>
									</p></li>
							<li><img src="${pageContext.request.contextPath}/resources/images/user4.png" alt="Avatar"
								class="img-circle pull-left avatar">
									<p>
										<a href="#">Jane</a> has completed all of the tasks <span
											class="timestamp">2 days ago</span>
									</p></li>
							<li><img src="${pageContext.request.contextPath}/resources/images/user5.png" alt="Avatar"
								class="img-circle pull-left avatar">
									<p>
