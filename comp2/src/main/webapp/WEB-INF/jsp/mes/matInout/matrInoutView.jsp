	...
	$(document).ready(function() {
		...
		const dataSource = {
			api : {
				...
				createData : {
					url : '${pageContext.request.contextPath}/ajax/insertMatInout',
					method : 'POST'
				},
				deleteData : {
					url : '${pageContext.request.contextPath}/ajax/deleteMatInout',
					method : 'POST'
				},
				updateData : {
					url : '${pageContext.request.contextPath}/ajax/updateMatInout',
					method : 'PUT'
				}
			},
